...
async def premium_plans_callback(update: Update, context: CallbackContext) -> None:
    ...
    try:
        ...
        plans_text = (
            ...
            "• All basic features\n"
            "• No FTM mode\n"
            f"• 15 days: ₹{Config.PLAN_PRICING['plus']['15_days']}\n"
            f"• 30 days: ₹{Config.PLAN_PRICING['plus']['30_days']}\n\n"
            ...
            f"• 15 days: ₹{Config.PLAN_PRICING['pro']['15_days']}\n"
            f"• 30 days: ₹{Config.PLAN_PRICING['pro']['30_days']}\n\n"
